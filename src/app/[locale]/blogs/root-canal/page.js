...
export async function generateMetadata({ params }) {
    ...
    const t = await getTranslations({ locale, namespace: 'blog-root-canal' });

    const baseUrl = 'https://toothmatedental.com';
    const articlePath = locale === 'ar' ? '/دليلك-الكامل-لحشو-العصب/مقالاتنا' : '/our-blogs/root-canal-treatment-egypt-2025';

    return {
        title: "سعر حشو العصب في مصر: تعرف على أهم العوامل المؤثرة",
        description: t('intro'),
        keywords: "سعر حشو العصب في مصر, علاج عصب الأسنان, أعراض التهاب العصب, تكلفة علاج العصب, ألم عصب الأسنان, حشوة العصب, علاج جذور الأسنان, ألم الأسنان الشديد, عيادة أسنان المعادي, root canal treatment, nerve inflammation, dental pain, endodontic treatment, tooth decay treatment, dental clinic Cairo",
        alternates: {
        ...
        openGraph: {
            ...
            authors: ['أخصائي علاج الجذور'],
            url: `${baseUrl}/${locale}${articlePath}`,
            siteName: 'Tooth Mate Dental Clinic',
            images: [
                {
                    url: `${baseUrl}/images/root-canal-photo.webp`,
                    width: 1200,
                    height: 630,
                    alt: "سعر حشو العصب في مصر: تعرف على أهم العوامل المؤثرة"
                }
            ],
            tags: ["علاج العصب", "ألم الأسنان", "طب الأسنان"]
        },
        twitter: {
            card: 'summary_large_image',
            title: "سعر حشو العصب في مصر: تعرف على أهم العوامل المؤثرة",
            description: t('intro'),
            images: [`${baseUrl}/images/root-canal-photo.webp`],
        },
        robots: {
            index: true,
            follow: true,
        ...
        authors: [{ name: 'أخصائي علاج الجذور' }],
...
export default async function RootCanalBlog({ params }) {
    const { locale } = await params;
    const t = await getTranslations({ locale, namespace: 'blog-root-canal' });
    ...
    const structuredData = {
        ...
        "@type": "BlogPosting",
        "headline": "سعر حشو العصب في مصر: تعرف على أهم العوامل المؤثرة",
        "description": t('intro'),
        "image": [
            `${baseUrl}/images/root-canal-photo.webp`,
            `${baseUrl}/images/root-canal-filling.webp`,
            `${baseUrl}/images/root-canal-photo-2.webp`,
        ...
        "author": {
            "@type": "Person",
            "name": "أخصائي علاج الجذور",
            "jobTitle": "أخصائي علاج الجذور",
        },
        "publisher": {
            "@type": "Organization",
        ...
        "keywords": "سعر حشو العصب في مصر, علاج عصب الأسنان, أعراض التهاب العصب",
        "articleSection": "علاج الجذور والأعصاب",
    ...
    const breadcrumbStructuredData = {
        ...
        "itemListElement": [
            ...
            },
            {
                "@type": "ListItem",
                "position": 3,
                "name": "سعر حشو العصب في مصر: تعرف على أهم العوامل المؤثرة",
    ...
    return (
        <>
            ...
            <section
                className="relative
                    bg-[url('/images/root-canal-photo.webp')] 
                    bg-cover bg-center 
                    h-[400px] w-full 
                    flex justify-center 
                    items-center
                ...
                aria-label={locale === 'ar'
                    ? 'سعر حشو العصب في مصر: تعرف على أهم العوامل المؤثرة'
                    : 'Root Canal Treatment Price in Egypt: Learn About the Most Influential Factors'
                }
            >
            ...
            <article className='container-custom max-w-6xl mx-auto' itemScope itemType="https://schema.org/Article">
                ...
                <div className='w-full h-[350px] md:h-[450px] lg:h-[500px] relative rounded-4xl overflow-hidden my-12'>
                    <Image
                        ...
                        alt={locale === 'ar'
                            ? 'توضيح خطوات عملية حشو العصب في عيادة الأسنان'
                            : 'Illustration of root canal filling procedure in dental clinic'
                        }
                        fill
                ...
                {/* CTA Section - Root Canal Consultation */}
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 items-center'>
                        ...
                        <div className='relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden'>
                            <Image
                                ...
                                alt={locale === 'ar'
                                    ? 'استشارة حشو العصب في عيادة توث ميت بالمعادي'
                                    : 'Root canal consultation at Tooth Mate clinic in Maadi'
                                }
                                fill
                                className='object-cover'
                            />
